...
/**
 * 自动同步 @react-native-ohos 和 @react-native-oh-tpl 包的 harmony.alias 配置到 tsconfig.json
 * 这样就不需要手动为每个包配置路径映射
 */
...
/**
 * 更新 tsconfig.json 中的 paths 配置
 */
function updateTsConfig(aliases) {
  if (Object.keys(aliases).length === 0) {
    console.log('\n⚠️  未找到任何 harmony.alias 配置');
    return;
  }
...
// 执行脚本
console.log('🔍 开始扫描 harmony.alias 配置...\n');
